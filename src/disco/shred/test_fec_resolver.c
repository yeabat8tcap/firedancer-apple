...
#define SIGN_REJECT( shred )                                                                                                                 \
  ...
  shred->idx = TEST_MAX-32UL;  shred->code.code_cnt = 32UL;  SIGN_ACCEPT( shred );
  shred->idx = TEST_MAX;       shred->code.code_cnt = 32UL;  SIGN_REJECT( shred );
  shred->idx = TEST_MAX+1UL;   shred->code.code_cnt = 32UL;  SIGN_REJECT( shred );
  ...
  shred->fec_set_idx = TEST_MAX-32UL;  shred->code.data_cnt = 32UL;      SIGN_ACCEPT( shred );
  shred->fec_set_idx = TEST_MAX- 2UL;  shred->code.data_cnt =  3UL;      SIGN_REJECT( shred );
